...
//   return (
//     <footer
//       className="text-primary-600 body-font bg-dark-700 mt-8 md:mt-14 w-full overflow-x-hidden"
//       id="footer"
//     >
//       <div className="w-full px-4 py-6 md:pt-4 pb-12 flex md:items-center  border-2 border-red-800 md:flex-row md:flex-nowrap flex-wrap flex-col max-w-6xl mx-auto">
//         <div className="flex-grow flex items-center flex-wrap md:pr-20 -mb-10 md:text-left text-start gap-16 order-first">
...
//             <div className="lg:w-1/4 md:w-1/2 w-full px-4">
//               <h2 className="font-semibold text-primary-600 tracking-normal md:tracking-widest text-xl md:text-2xl font-[nunito] pb-5 whitespace-nowrap">
//                 Quick Links
//               </h2>
...
//               </nav>
//             </div>
//             <div className=" md:w-1/2 w-full px-4 flex flex-col items-start gap-8">
//               <div className=" font-semibold text-primary-600  tracking-widest text-2xl font-[Resgak] mb-5">
//                 <div className="relative w-full lg:w-80 h-40 lg:h-36">
//                   {" "}
//                   <iframe
//                     className="absolute top-0 left-0 w-[363px] h-[190px] border-0"
...
//                 </div>
//               </div>
//               <h2 className="text-center tracking-wide text-sm sm:text-xl md:text-2xl">
//                 Around the web
//               </h2>
//               <nav className="list-none mb-10 flex items-start gap-6 justify-center">
//                 <li>
//                   <a className="text-primary-600  ">
...
//           <li>
//             <a className="text-sm md:text-base text-primary-600 whitespace-normal">
