...
//                 <svg
//                   className="w-6 h-6 sm:w-8 sm:h-8 text-[#C5AC8D]"
//                   fill="currentColor"
//                   viewBox="0 0 24 24"
//                 >
...
//               className="border-b border-[#202020] outline-none p-2 bg-transparent w-full"
//             />
//             <button className="border border-[#202020] rounded-full px-8 py-2 mt-4">
//               Send
//             </button>
//           </form>
//         </div>
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row md:justify-end relative">
        <div className="contact-info-box bg-[#18473D] text-white p-2 sm:p-6 md:p-6 w-[250px] h-fit sm:w-[300px] md:w-[394px] md:h-[450px] md:absolute md:left-2 md:translate-y-16 z-20 translate-y-24 translate-x-16 sm:translate-x-12 py-3 md:py-6">
          ...
          <div className="space-y-4 sm:space-y-8">
            <div className="flex items-center md:items-start gap-2 sm:gap-4">
              <span className="flex-shrink-0">
                <svg
                  className="w-5 h-5 sm:w-8 sm:h-8 text-[#C5AC8D]"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
                  <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" />
        ...
        {/* Form Box */}
        <div className="border border-[#44D8B8] w-full sm:w-[450px] h-[490px] md:w-[970px] md:h-[583px] min-h-[583px] z-10 p-4 sm:p-8 md:p-16 shadow-md mt-4 md:mt-0">
          <form className="flex flex-col gap-6 sm:gap-8 items-start justify-center md:max-w-[600px] md:ml-auto pt-24 md:pt-0">
            <h2 className="text-[#18473D] text-xl sm:text-2xl font-semibold md:mb-8 mb-2">
              Send a message
            </h2>
            <input
              type="text"
              placeholder="Name*"
              className="border-b border-[#202020] outline-none p-2 bg-transparent w-full py-2 sm:py-4"
            />
            <div className="flex flex-col md:flex-row md:items-center md:gap-8 gap-4 w-full">
              <input
                type="email"
            ...
            <input
              ...
              className="border-b border-[#202020] outline-none p-2 bg-transparent w-full"
            />
            <button className="border border-[#202020] rounded-full px-6 sm:px-8 py-2 mt-4">
              Send
            </button>
          </form>
        </div>
