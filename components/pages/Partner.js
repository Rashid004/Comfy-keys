  ...
  return (
    ...
    >
      <div className="container mx-auto grid grid-cols-1 items-start md:grid-cols-2 gap-4">
        ...
        <div className="absolute bg-dark-500 w-4/5 h-64 sm:w-[60%] sm:h-72  md:w-[40%] md:h-[60%] -translate-y-5 sm:-translate-y-4 md:-translate-y-5 right-4 sm:right-0 sm:-translate-x-[53%] md:-translate-x-[82px] md:-right-9 z-0"></div>
        ...
        <div className="relative z-10 order-1 md:order-2">
          <Image
            ...
            width={561}
            height={486}
            className="object-cover object-center shadow-md w-[95%] h-fit sm:w-2/3 sm:h-[310px]  md:w-[561px] md:h-[486px]"
          />
        </div>
      </div>
    </section>
