      ...
      <div className="container mx-auto grid grid-cols-1 items-start md:grid-cols-2 gap-4">
        <div className="flex flex-col order-2 md:order-1 pr-2 sm:pr-6">
          <div className="relative md:absolute -top-4 sm:-top-24 md:top-44 md:right-0 z-20 mt-8 sm:mt-32 md:mt-0 flex items-start justify-start flex-col">
            <h1 className="text-xl sm:text-4xl md:text-[66px] mb-2 font-semibold md:font-bold text-[#18473D] font-[nunito] uppercase tracking-[3px] sm:tracking-[5px] md:tracking-[9.6px] md:text-left md:mb-6">
              Partner With Us
            </h1>
            <p className="text-[#ABA7A7] md:mb-4 text-start md:text-left w-full md:w-[45%] text-sm sm:text-[14px] md:text-base">
              <span className="text-[#848282] leading-normal font-semibold mb-2 md:mb-4 block">
                Welcome to Comfy Keys — Your Gateway to Comfortable Living
              </span>
              Welcome to Comfy Keys — Your Trusted Partner in Property Success.
              When you partner with Comfy Keys, you benefit from dependable
        ...
        <div className="absolute bg-[#18473D] w-[250px] h-[220px] sm:h-[257px] md:w-[40%] md:h-[60%] -translate-y-4 sm:-translate-y-4 md:-translate-y-5 right-10 sm:right-[45%] md:-translate-x-[82px] md:-right-9 z-0"></div>
