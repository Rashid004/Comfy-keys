...
export default function Home() {
  return (
    <div className="relative h-screen mb-8 md:mb-0 overflow-x-hidden" id="home">
      ...
      <div className="relative z-10 flex flex-col justify-center items-center md:items-start h-full p-4 sm:p-6 md:p-10 bg-black bg-opacity-50">
        <div className="w-full max-w-7xl mx-auto">
          <h1 className="font-[nunito] text-white text-3xl sm:text-4xl md:text-6xl font-bold mb-4 text-center md:text-left">
            Welcome to <br className="sm:hidden" />
            Comfy Keys
          </h1>
          <p className="text-white text-base sm:text-lg md:text-xl lg:text-[36px] py-2 sm:py-4 mb-4 sm:mb-6 text-center md:text-left leading-snug md:w-4/5 w-full md:leading-relaxed">
            Experience the Comfort of Home <br className="md:hidden" />
            Away from Home at comfy keys
          </p>

          <div className="flex justify-center md:justify-start">
            <button className="bg-white text-[#18473D] rounded-full px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base md:text-lg font-semibold hover:bg-gray-100 transition-all duration-300 ease-in-out inline-flex items-center">
              Contact Us{" "}
              <span className="ml-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
